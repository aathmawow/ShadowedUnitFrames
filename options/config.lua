			...
			general = {
				...
				args = {
					...
					barEssence = {
						...
						inline = true,
						name = L["Essence"],
						hidden = function(info) return playerClass ~= "EVOKER" or not getVariable(info[2], "essence", nil, "isBar") or not getVariable(info[2], nil, nil, "essence") end,
						args = {
							enabled = {
								order = 1,
								type = "toggle",
					...
					essence = {
						...
						inline = true,
						name = L["Essence"],
						hidden = function(info) if( info[2] == "global" or getVariable(info[2], "essence", nil, "isBar") ) then return true end return hideRestrictedOption(info) end,
						args = {
							enabled = {
								order = 0,
								type = "toggle",
